...
L["Hide Grouped Items"] = "Скрыть сгруппированные элементы" -- Needs review
...
-- L["Normal Mode"] = ""
-- L["Normal Post Price"] = ""
L["NOTE: The scan must be stopped before you can buy anything."] = "Примечание: проверка должна быть остановлена, прежде чем вы сможете купить что-либо." -- Needs review
-- L["Num"] = ""
-- L["Operation Name"] = ""
-- L["Operations"] = ""
L["Options"] = "Настройки"
