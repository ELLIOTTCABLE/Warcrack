...
L["Buff spell list"] = "Buff 法术列表" -- Needs review
L["Buff uptimes"] = "Buff 覆盖时间" -- Needs review
...
L["Hide window"] = "隐藏窗体" -- Needs review
...
L["Self"] = "自身"
L["Send report"] = "发送报告"
L["Sets the scale of the window."] = "设置窗体的缩放" -- Needs review
L["Shake screen"] = "震动屏幕"
