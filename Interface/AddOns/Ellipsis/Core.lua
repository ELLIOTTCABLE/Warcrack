...
--			if (t.created < 3 or guid == 'notarget' or bit.band(0x00F0000000000000, guid) == 0x0030000000000000) then
...
--			end
		...
		for guid, t in pairs(activeGUIDS) do
			if (guid ~= 'notarget' and t.created > 2 and strsplit('-', guid) == 'Creature') then --bit.band(0x00F0000000000000, guid) == 0x0030000000000000) then
				self:DestroyTarget(guid)
			end
		end
	end
