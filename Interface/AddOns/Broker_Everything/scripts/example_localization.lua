--[[ shared ]]
L["Alt"] = "" -- shared.lua
L["Alt+Click"] = "" -- friends.lua, guild.lua
L["Are you sure you want to Reload the UI?"] = "" -- gamemenu.lua, stuff.lua
L["Bags"] = "" -- bags.lua, durability.lua
L["Broker to allow you to do...Stuff! Switch to windowed mode, reload ui, logout and quit."] = "" -- gamemenu.lua, stuff.lua
L["Broker to show your different currencies."] = "" -- currency.lua, followers.lua, garrison.lua, missions.lua
L["Broker to show, equip, delete, update and save equipment sets"] = "" -- equipment.lua, surprise.lua
L["Character"] = "" -- durability.lua, friends.lua, guild.lua
L["Click"] = "" -- calendar.lua, equipment.lua, fps.lua, friends.lua, gold.lua, guild.lua, nameplates.lua, questlog.lua, tracking.lua, volume.lua, xp.lua
L["Ctrl"] = "" -- shared.lua
L["Ctrl+Click"] = "" -- equipment.lua, fps.lua
L["Delete a set"] = "" -- equipment.lua, fps.lua
L["Follower"] = "" -- followers.lua, missions.lua
L["Friendly"] = "" -- durability.lua, gps.lua
L["Gold coloring"] = "" -- optionspanel.lua, bags.lua, durability.lua, gold.lua
L["Hold '..mod])..' || '..C('green',L['Show expire date instead of duration"] = "" -- garrison.lua, ids.lua, professions.lua
L["Left alt"] = "" -- shared.lua
L["Left ctrl"] = "" -- shared.lua
L["Left shift"] = "" -- shared.lua
L["Left-click"] = "" -- bags.lua, clock.lua, currency.lua, dualspec.lua, durability.lua, friends.lua, gamemenu.lua, gps.lua, guild.lua, mail.lua, memory.lua, professions.lua, stuff.lua, volume.lua
L["Level"] = "" -- clock.lua, followers.lua, friends.lua, garrison.lua, guild.lua, missions.lua, questlog.lua
...
L["None"] = "" -- optionspanel.lua, nameplates.lua
L["Notes"] = "" -- friends.lua, guild.lua
L["Open calendar"] = "" -- calendar.lua, clock.lua
L["Open currency pane"] = "" -- currency.lua, gold.lua
L["Open option menu"] = "" -- currency.lua, durability.lua, friends.lua, guild.lua, latency.lua, mail.lua, professions.lua
L["Options"] = "" -- core.lua, optionspanel.lua, shared.lua, latency.lua
L["Place"] = "" -- currency.lua, professions.lua
L["Precision"] = "" -- gps.lua, speed.lua
L["Professions"] = "" -- followers.lua, guild.lua
L["Quit game"] = "" -- gamemenu.lua, stuff.lua
L["Reload UI"] = "" -- optionspanel.lua, gamemenu.lua, stuff.lua
L["Right alt"] = "" -- shared.lua
L["Right ctrl"] = "" -- shared.lua
L["Right shift"] = "" -- shared.lua
L["Right-click"] = "" -- bags.lua, clock.lua, currency.lua, dualspec.lua, durability.lua, friends.lua, gamemenu.lua, gold.lua, gps.lua, guild.lua, latency.lua, mail.lua, memory.lua, professions.lua, stuff.lua, volume.lua, xp.lua
L["Shift"] = "" -- shared.lua
L["Shift+Click"] = "" -- equipment.lua, fps.lua
L["Shift+Left-click"] = "" -- clock.lua, gamemenu.lua, stuff.lua
L["Shift+Right-click"] = "" -- clock.lua, memory.lua
L["Suffix coloring"] = "" -- optionspanel.lua, latency.lua
L["Type"] = "" -- ids.lua, missions.lua
L["Unknown"] = "" -- bags.lua, followers.lua, framenames.lua
L["Update/save a set"] = "" -- equipment.lua, fps.lua
L["Use colors instead of icons for gold, silver and copper"] = "" -- optionspanel.lua, bags.lua, durability.lua, gold.lua
L["XP"] = "" -- followers.lua, guild.lua, xp.lua
L["Zone"] = "" -- friends.lua, gps.lua, guild.lua
L["iLevel"] = "" -- followers.lua, missions.lua
...
L["Show professions"] = ""
L["Show realm name"] = ""
L["Show/Hide realm names behind guild and character names. Guilds and characters from connected-realms gets an asterisk behind the names if this option is unchecked."] = ""
L["Tank"] = ""
