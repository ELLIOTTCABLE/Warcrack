--[[
	...
	Revision: $Id: PriceLevel.lua 4861 2010-09-02 23:35:36Z kandoko $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.12/Auc-Util-PriceLevel/PriceLevel.lua $", "$Rev: 4861 $")
