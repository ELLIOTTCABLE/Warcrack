...
local MINOR_VERSION = 90000 + tonumber(("$Rev: 332 $"):match("%d+"))
...
elseif GAME_LOCALE == "ruRU" then
	...
	["Opening of the Dark Portal"] = "Открытие Темного портала", -- Needs review
	Orgrimmar = "Оргриммар",
	Outland = "Запределье",
	...
	["The Escape From Durnholde"] = "Побег из Дарнхольда", -- Needs review
	["The Exodar"] = "Экзодар",
	["The Eye"] = "Око",
