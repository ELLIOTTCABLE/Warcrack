...
-- L["OPT_LABEL_ACHFOUR"] = ""
L["OPT_LABEL_ACHTHREE"] = "\"%s,\" \"%s,\" et|n\"%s\"" -- Needs review
...
L["OPT_LABEL_TRADESKILLUI"] = "Modifications de l'UI des professions" -- Needs review
...
L["OPT_TRADESKILL_SHOWCOMPLETEDACH_COOKING"] = "Indique les recettes non préparées pour compléter les haut-faits" -- Needs review
-- L["OPT_TRADESKILL_SHOWCOMPLETEDACH_COOKING_TIP"] = ""
...
L["OPT_KILLCREATURETIPS_TIP2"] = "Заметка: В начале (или когда эта опция включена), каждое достижение сканируется на поиск Номера НПС. Не все достижения предоставляют правильные Номера. Поэтому подсказки для существ которые подходят по критериям не будут отображатся этой опцией."
-- L["OPT_LABEL_ACHFOUR"] = ""
L["OPT_LABEL_ACHTHREE"] = "\"%s,\" \"%s,\" и|n\"%s\"" -- Needs review
...
L["OPT_TRADESKILL_SHOWCOMPLETEDACH_COOKING"] = "Отображает не приготовленные рецепты для завершения достижений" -- Needs review
L["OPT_TRADESKILL_SHOWCOMPLETEDACH_COOKING_TIP"] = "Если торговый модуль Overachiever'а включен, иконка достижения появится рядом с рецептом, который необходимо приготовить для получения соответствующего достижения. Если эта опция включена, эти иконки будут появляться рядом с не приготовленными рецептами даже если эти достижения завершены." -- Needs review
...
L["ACH_ANGLER_COMPLETE"] = "Já Pescado"
L["ACH_ANGLER_INCOMPLETE"] = "Precisa pescar"
-- L["ACH_BUNNYMAKER_COMPLETE"] = ""
-- L["ACH_BUNNYMAKER_INCOMPLETE"] = ""
-- L["ACH_CHECKYOURHEAD_COMPLETE"] = ""
-- L["ACH_CHECKYOURHEAD_INCOMPLETE"] = ""
L["ACH_CONSUME_91_COMPLETE"] = "Gula já comprovada" -- Needs review
L["ACH_CONSUME_91_INCOMPLETE"] = "Eu te desafio a comer 91 de uma vez!"
L["ACH_CONSUME_COMPLETE"] = "Já Consumido"
L["ACH_CONSUME_INCOMPLETE"] = "Precisa consumir"
L["ACH_CONSUME_INCOMPLETE_EXTRA"] = "Ainda não consumido"
-- L["ACH_FISHSCHOOL_FORMAT"] = ""
L["ACH_FISTFULOFLOVE_COMPLETE"] = "Punhado de Petalas de Rosa Já Utilizado"
...
L["ACH_LOVECRITTERS_COMPLETE"] = "Já /Amei"
L["ACH_LOVECRITTERS_INCOMPLETE"] = "Precisa /amar"
-- L["ACH_TURKEYLURKEY_COMPLETE"] = ""
-- L["ACH_TURKEYLURKEY_INCOMPLETE"] = ""
L["ACH_WELLREAD_COMPLETE"] = "Já Leu"
...
L["BINDING_NAME_OVERACHIEVER_TAB_WATCH"] = "Abir Aba de Observação" -- Needs review
L["COMPLETEDATE"] = "Completado em  %2$d/%1$02d/%3$02d"
L["CRITTER"] = "Bicho"
L["INCOMPLETE"] = "Incompleto"
L["KILL_COMPLETE"] = "Ja matado."
L["KILL_INCOMPLETE"] = "Precisa matar"
L["MSG_ACHNOTFOUND"] = "Conquista não encontrada."
L["MSG_INVALIDID"] = "Dados invalidos: Nenhuma conquista com essa ID"
L["MSG_NAMENOTFOUND"] = "Nenhuma conquista contendo  \"|cffffffff%s|r\" foi encontrada"
...
-- L["OPT_ANGLERTIPS"] = ""
-- L["OPT_ANGLERTIPS_TIP"] = ""
L["OPT_AUTOTRACKEXPLORE"] = "Visualize conquistas de exploração enquanto voce viaja"
L["OPT_AUTOTRACKEXPLORE_COMPLETED"] = "Incluindo conquistas completadas"
L["OPT_AUTOTRACKEXPLORE_TIP"] = "Quando entrar numa área, automaticamente evidencie a conquista de exploração. Se você ja está evidenciando alguma outra conquista desse tipo, isso vai substituir a antiga conquista, se esta for de exploração é claro."
-- L["OPT_AUTOTRACKTIMED"] = ""
-- L["OPT_AUTOTRACKTIMED_TIP"] = ""
L["OPT_BUNNYMAKERTIPS"] = "Flores da Primavera ja usado?" -- Needs review
-- L["OPT_BUNNYMAKERTIPS_TIP"] = ""
-- L["OPT_CHECKYOURHEADTIPS"] = ""
-- L["OPT_CHECKYOURHEADTIPS_TIP"] = ""
...
L["OPT_CRITTERTIPS"] = "Criatura /amar?"
-- L["OPT_CRITTERTIPS_TIP"] = ""
L["OPT_DRAG_ACHFRAME"] = "Página das Conquistas principais"
L["OPT_DRAG_ACHTRACKER"] = "Rastreador de Conquistas"
L["OPT_DRAGGABLE"] = "Tornar arrastaveis" -- Needs review
L["OPT_DRAGLOCK"] = "Travar posição"
L["OPT_DRAGSAVE"] = "Lembrar Posição"
L["OPT_FISTFULOFLOVETIPS"] = "Punhado de Pétalas de Rosas usadas?"
-- L["OPT_FISTFULOFLOVETIPS_TIP"] = ""
L["OPT_KILLCREATURETIPS"] = "Creatura morta?"
-- L["OPT_KILLCREATURETIPS_TIP"] = ""
-- L["OPT_KILLCREATURETIPS_TIP2"] = ""
L["OPT_LABEL_ACHFOUR"] = "\"%s,\" \"%s,\"|n\"%s,\" \"%s\""
L["OPT_LABEL_ACHTHREE"] = "\"%s,\" \"%s,\" e \"%s\""
L["OPT_LABEL_ACHTWO"] = "\"%s\" e \"%s\""
L["OPT_LABEL_DRAG"] = "Quadro mudável"
L["OPT_LABEL_MAINUI"] = "Modificações nas Conquistas Principais"
-- L["OPT_LABEL_NEEDTOKILL"] = ""
-- L["OPT_LABEL_SEASONALACHS"] = ""
L["OPT_LABEL_TOOLTIPS"] = "Dicas para Conquistas"
L["OPT_LABEL_TRACKING"] = "Conquistas envidenciadas"
-- L["OPT_LABEL_TRADESKILLUI"] = ""
...
-- L["OPT_SELECTSOUND_ANGLERCHECKPOLE_TIP"] = ""
-- L["OPT_SELECTSOUND_TIP"] = ""
L["OPT_SELECTSOUND_TIP2"] = "Sons serão ouvidos apenas uma vez a cada 15 segundos"
L["OPT_SHOWID"] = "Mostras ID das Conquistas"
L["OPT_SHOWPROGRESS"] = "Adc seu progresso"
-- L["OPT_SHOWPROGRESS_OTHER"] = ""
-- L["OPT_SHOWPROGRESS_OTHER_TIP"] = ""
-- L["OPT_SHOWPROGRESS_TIP"] = ""
-- L["OPT_TRACKERGREENCHECK"] = ""
...
-- L["OPT_WELLREADTIPS_TIP"] = ""
L["PROGRESS"] = "Progressão"
L["REQUIREDFORMETATIP"] = "Requerido para:"
L["SERIESTIP"] = "Parte da progressão:"
