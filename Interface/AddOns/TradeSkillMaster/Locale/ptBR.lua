...
L["Add Items to this Group"] = "Adicione itens a esse grupo" -- Needs review
L["Additional error suppressed"] = "Erro adicional suprimido"
L["Adjust Post Parameters"] = "Ajuste os parâmetros de postagem" -- Needs review
L["Advanced Option Text"] = "Opções avançadas de texto" -- Needs review
L["Advanced topics..."] = "Tópicos Avançados" -- Needs review
...
L["Along the top of the TSM_Crafting window, click on the 'TSM Groups' button."] = "Na parte superior da janela do \"TSM_Artesanato\", clique no botão \"TSM_Grupos\"" -- Needs review
L["Along top of the window, on the left side, click on the 'Groups' icon to open up the TSM group settings."] = "Junto a parte superior da janela, do lado esquerdo, clique no ícone 'Grupos' para abrir as configurações do grupo de TSM" -- Needs review
L["Along top of the window, on the left side, click on the 'Module Operations / Options' icon to open up the TSM module settings."] = "Na parte superior da janela, do lado esquerdo, clique no ícone 'Módulo de Operações / Opções \"para abrir as configurações do módulo TSM." -- Needs review
L["Along top of the window, on the right side, click on the 'Crafting' icon to open up the TSM_Crafting page."] = "Junto a parte superior da janela, do lado direito, clique no ícone \"Artesanato\" para abrir a página \"TSM_Artesanato\"." -- Needs review
...
L["Assign this operation to the group you previously created by clicking on the 'Yes' button in the popup that's now being shown."] = "Atribuir esta operação para o grupo criado anteriormente clicando no botão \"Sim\" no pop-up que está sendo mostrado." -- Needs review
L["A TSM_Auctioning operation will allow you to set rules for how auctionings are posted/canceled/reset on the auction house. To create one for this group, scroll down to the 'Auctioning' section, and click on the 'Create Auctioning Operation' button."] = "A operação TSM_Leilão ira permitir a você definir um conjunto de regras de como seus leilões serão publicados/cancelados/reiniciados na casa de leilões. Para criar uma para esse grupo, role para baixo, para seção \"Leiloando\", e aperte no botão \"Criar uma operação de leilão\"." -- Needs review
...
L["<No Group Selected>"] = "<Grupo não selecionado>" -- Needs review
...
L["<No Operation Selected>"] = "<Operação não selecionada>" -- Needs review
