...
local CensusPlus_Version_Major = "6"; -- changing this number will force a saved data purge
local CensusPlus_Version_Minor = "3"; -- changing this number will force a saved data purge
local CensusPlus_Version_Maint = "0";
local CensusPlus_SubVersion = " >=WoD6.1.2";
...
-- local MAX_CHARACTER_LEVEL = 90;					-- Maximum level a PC can attain
local LATEST_XPAC_LIMIT = 100		--WoD limit
local expansions = 10								-- arbitrary number for max expansion packs for WoW
...
CensusPlus_Jobs = {}; 					-- hold pre-existing Jobs queue and status.
...
local function CensusPlus_Zero_g_TimeDatabase()
	...
	g_TimeDatabase[CENSUSPLUS_MONK]  = 0;
end
...
function CensusPlus_GetFactionRaces(faction)
	...
	if (faction == CENSUSPlus_HORDE) then
		ret = {CENSUSPLUS_ORC, CENSUSPLUS_TAUREN, CENSUSPLUS_TROLL, CENSUSPLUS_UNDEAD, CENSUSPLUS_BLOODELF, CENSUSPLUS_GOBLIN, CENSUSPLUS_HPANDAREN };
	elseif (faction == CENSUSPlus_ALLIANCE) then
		ret = {CENSUSPLUS_DWARF, CENSUSPLUS_GNOME, CENSUSPLUS_HUMAN, CENSUSPLUS_NIGHTELF, CENSUSPLUS_DRAENEI, CENSUSPLUS_WORGEN, CENSUSPLUS_APANDAREN};
	end
	return ret;
end
...
function CensusPlus_GetFactionClasses(faction)  
 -- this is last in first out list... add new classes to front of list.
	local ret = {};
	if (faction == CENSUSPlus_HORDE) then
		ret = {CENSUSPLUS_MONK, CENSUSPLUS_DEATHKNIGHT, CENSUSPLUS_PALADIN, CENSUSPLUS_SHAMAN, CENSUSPLUS_WARRIOR, CENSUSPLUS_WARLOCK, CENSUSPLUS_ROGUE, CENSUSPLUS_PRIEST, CENSUSPLUS_MAGE, CENSUSPLUS_HUNTER, CENSUSPLUS_DRUID};
	elseif (faction == CENSUSPlus_ALLIANCE) then
		ret = {CENSUSPLUS_MONK, CENSUSPLUS_DEATHKNIGHT, CENSUSPLUS_PALADIN, CENSUSPLUS_SHAMAN, CENSUSPLUS_WARRIOR, CENSUSPLUS_WARLOCK, CENSUSPLUS_ROGUE, CENSUSPLUS_PRIEST, CENSUSPLUS_MAGE, CENSUSPLUS_HUNTER, CENSUSPLUS_DRUID};
	end
	return ret;
...
local function GetRaceClasses(race)
	...
	elseif (race == CENSUSPLUS_TAUREN) then
		ret = {CENSUSPLUS_PALADIN, CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_SHAMAN, CENSUSPLUS_PRIEST, CENSUSPLUS_DRUID, CENSUSPLUS_DEATHKNIGHT, CENSUSPLUS_MONK};
	elseif (race == CENSUSPLUS_TROLL) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_ROGUE, CENSUSPLUS_PRIEST, CENSUSPLUS_SHAMAN, CENSUSPLUS_MAGE, CENSUSPLUS_DRUID, CENSUSPLUS_WARLOCK, CENSUSPLUS_DEATHKNIGHT, CENSUSPLUS_MONK};
	elseif (race == CENSUSPLUS_UNDEAD) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_ROGUE, CENSUSPLUS_PRIEST, CENSUSPLUS_MAGE, CENSUSPLUS_WARLOCK, CENSUSPLUS_DEATHKNIGHT, CENSUSPLUS_MONK};
	elseif (race == CENSUSPLUS_DWARF) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_PALADIN, CENSUSPLUS_HUNTER, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_PRIEST, CENSUSPLUS_SHAMAN, CENSUSPLUS_WARLOCK, CENSUSPLUS_DEATHKNIGHT, CENSUSPLUS_MONK};
	elseif (race == CENSUSPLUS_GNOME) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_PRIEST, CENSUSPLUS_WARLOCK, CENSUSPLUS_DEATHKNIGHT, CENSUSPLUS_MONK};
	...
	elseif (race == CENSUSPLUS_NIGHTELF) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_MAGE, CENSUSPLUS_ROGUE, CENSUSPLUS_PRIEST, CENSUSPLUS_DRUID, CENSUSPLUS_DEATHKNIGHT, CENSUSPLUS_MONK};
	elseif (race == CENSUSPLUS_BLOODELF) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_PALADIN, CENSUSPLUS_HUNTER, CENSUSPLUS_ROGUE, CENSUSPLUS_PRIEST, CENSUSPLUS_MAGE, CENSUSPLUS_WARLOCK, CENSUSPLUS_DEATHKNIGHT, CENSUSPLUS_MONK};
	elseif (race == CENSUSPLUS_DRAENEI) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_PALADIN, CENSUSPLUS_HUNTER, CENSUSPLUS_PRIEST, CENSUSPLUS_SHAMAN, CENSUSPLUS_MAGE, CENSUSPLUS_DEATHKNIGHT, CENSUSPLUS_MONK};
	...
	elseif (race == CENSUSPLUS_APANDAREN) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_PRIEST, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_MONK};
...
--debug
	...
	if (HortonBug == true) then
		...
		if CensusPlayerOnly then
		  if (not(CPp.IsCensusPlusInProgress)) then
...
-- first load queue with jobs in increment of 10 from 1-10 thru max_character_level-19 - max_character_level-10
      	...
      	for counter = 0,floor(MAX_CHARACTER_LEVEL /10)-2, 1 do
      	...
      	for counter = 0,floor(MAX_CHARACTER_LEVEL /10)-1, 1 do
        	local job = CensusPlus_CreateJob( counter*10 + 1, counter*10+10, nil, nil, nil );
        	InsertJobIntoQueue(job);
      	end
			end			 
...
--CensusPlus_Msg( " UPDATE GUILD " );
	...
	elseif (event == "UPDATE_MOUSEOVER_UNIT" ) and (UnitIsPlayer("mouseover")) then
	  CensusPlus_ProcessTarget("mouseover")
	elseif (event == "PLAYER_TARGET_CHANGED") and (UnitIsPlayer("target")) then
...
--	if(not (CensusPlus_PerCharInfo["Version"] == nil)) then
--print("PerCharacter version ".. CensusPlus_PerCharInfo["Version"])
		g_InterfaceVersion = CensusPlus_PerCharInfo["Version"]
		if(g_InterfaceVersion ~= CensusPlus_VERSION)then
...
--	local  realmID, name, apiName, rules, locale, battlegroup, region, timezone, connected, latinName = LibStub("LibRealmInfo"):GetRealmInfoByUnit("Player")
		local  realmID, _, _, _, _, _, regionKey, _, _, _ = LibStub("LibRealmID"):GetRealmInfoByUnit("Player")
--print("regionKey = ")
--print(regionKey)
--[[		local regionKey = GetCVar("portal") == "public-test" and "PTR" or GetCVar("portal")
...
--			g_Times_ForAllCharacters(MemberRealm, factionGroup, classKey, ClassCount);
				...
				for realmKey,factionData in pairs(g_TempCount) do   -- realmname, factionname
--					if (HortonBug == true) then
...
--												end
				...
				g_TimeDatabase[charClass] = g_TimeDatabase[charClass] + classCount;
				g_NumUpdatedCharacters = g_NumUpdatedCharacters + classCount;
-- debug line
--				if (HortonBug == true) then
--					s.ays("Class= " .. g_TimeDatabase[charClass].." Updates= " .. g_NumUpdatedCharacters);
--				end
			end						
--]]
			...
			if (CensusPLus_DEBUGWRITES) then 
				local total_time = time() - g_CensusPlus_StartTime;
				local hour, minute = GetGameTime();
--					CensusPlus_Database["TimesPlus"][realmData][factionData]["" .. hour .. ""] = g_TimeDatabase;
				CensusPlus_Database["TimesPlus"][MemberRealm][factionGroup] =
				...
				g_TimeDatabase[CENSUSPLUS_MONK] .. "&" ..
				CensusPlus_WHOPROCESSOR .. ":" .. g_NumNewCharacters .."," .. g_NumUpdatedCharacters .."," .. total_time;
			else		
--				if (HortonBug == true) then
...
--					CensusPlus_Database["TimesPlus"][realmData][factionData]["" .. hour .. ""] = g_TimeDatabase;
				...
				g_TimeDatabase[CENSUSPLUS_PALADIN] .. "&" ..
				g_TimeDatabase[CENSUSPLUS_DEATHKNIGHT] .. "&" ..
				g_TimeDatabase[CENSUSPLUS_MONK] .."&0&0&0";
			end
		end							
...
-- 5.4  g_TempCount[realm][name] = class;  
		local gct_realm = g_TempCount[realmName];
		if (gct_realm == nil) then
			g_TempCount[realmName] = {};
			gct_realm = g_TempCount[realmName];
		end
