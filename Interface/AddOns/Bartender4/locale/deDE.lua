...
L["Bars unlocked. Move them now and click Lock when you are done."] = "Die Aktionsleisten lassen sich jetzt per Drag and Drop verschieben. Sperren Sie anschließend die Leisten." -- Needs review
...
L["|cffffff00Click|r to toggle bar lock"] = "|cffffff00Klicken|r um das Anpassen der Leisten umzuschalten." -- Needs review
L["|cffffff00Right-click|r to open the options menu"] = "|cffffff00Rechtsklicken|r um die Optionen zu öffnen." -- Needs review
...
L["Lion"] = "Löwe"
L["Lock"] = "Sperren" -- Needs review
L["Lock all bars."] = "Anordnen der Aktionsleisten per Drag and Drop." -- Needs review
L["Lock the buttons."] = "Alle Schaltflächen innerhalb von den Aktionsleisten sperren." -- Needs review
