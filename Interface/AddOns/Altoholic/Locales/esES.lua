...
L["Clamp window to screen"] = "Fijar ventana a la pantalla" -- Needs review
...
L["Compare with"] = "Comparar con" -- Needs review
...
L["Memory used"] = "Memoria usada" -- Needs review
...
L["Newer data"] = "Datos recientes" -- Needs review
...
L["Olaf"] = true
L["Older data"] = "Datos antiguos" -- Needs review
...
L["Other"] = "Otros"
L["Other characters"] = "Otros personajes" -- Needs review
L["Other guilds"] = "Otras hermandades." -- Needs review
...
L["This account"] = "Esta cuenta" -- Needs review
...
L["TIME_TO_NEXT_WARNING_TEXT"] = "Tiempo hasta el siguiente aviso" -- Needs review
L["TIME_TO_NEXT_WARNING_TOOLTIP"] = "Tiempo hasta el siguiente aviso de caducidad de correo." -- Needs review
...
L["Update current tab from"] = "Actualizar pestaña actual desde" -- Needs review
L["Upper Deck"] = true
L["up to"] = "hasta"
L["Up to %s"] = "Hasta %s"
L["Use color-coding for recipes at the AH"] = "Usa códigos de colores para las recetas en la subasta" -- Needs review
L["Use color-coding for recipes at vendors"] = "Usa códigos de colores para las recetas en los vendedores" -- Needs review
...
L["Will be %sdeleted|r in"] = "%s se borrará|r en" -- Needs review
L["Will be %sreturned|r in"] = "%s se devolverá|r en" -- Needs review
