...
GridStatusHots.L = {
	...
	["Check, if you want to see the Weakened Soul Timer behind the Pw: Shield Timer(i.e. 13-5)"]= "Отметьте, если вы хотите видеть таймер Ослабленной Души после таймера Сс: Щит (i.e. 13-5)",
