...
L["Destroy Mode"] = "分解模式"
L["% DE Value"] = "%的DE值"
L["Disenchant Search Profit: %s"] = "分解搜索利润: %s"
...
L["Items which are below their maximum price (per their group / Shopping operation) will be displayed in Sniper searches."] = "下列物品的最高价（每分组/Shopping操作）将显示在狙击搜索中"
...
L["NOTE: The scan must be stopped before you can buy anything."] = "注意：在购买物品前必须停止扫描"
L["Num"] = "数量"
...
L["The duration at which items will be posted via the 'Quick Posting' frame."] = "分解搜索将根据下面的分解价值在拍卖行中搜索物品。你可以再购买通用设置中设置最高分解价值百分比"
