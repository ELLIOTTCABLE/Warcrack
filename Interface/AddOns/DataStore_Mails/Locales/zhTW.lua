...
L["EXPIRY_ALL_ACCOUNTS_LABEL"] = "檢查所有已知帳戶的將屆滿郵件" -- Needs review
...
L["EXPIRY_ALL_REALMS_LABEL"] = "檢查所有已知伺服器的將屆滿郵件" -- Needs review
...
L["EXPIRY_CHECK_LABEL"] = "郵件屆滿警告" -- Needs review
...
L["SCAN_MAIL_BODY_LABEL"] = "掃描郵件內容 (標記為己讀取)" -- Needs review
