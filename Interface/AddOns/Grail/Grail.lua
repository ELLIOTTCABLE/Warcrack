...
--						print("Gossip index selected:", index, text, confirm)
					...
					local nameToUse
					local zoneNames
					local inWoD = (self.blizzardRelease >= 18505)
					...
					if inWoD then tinsert(self.continentMapIds, 962) end	-- 962 Draenor
					...
					for i = 1, #(continentNames), (1 + offset) do
						mapId = inWoD and tonumber(continentNames[i]) or self.continentMapIds[i]
...
--				['R'] = 'Riding', ['S'] = 'Skinning', ['T'] = 'Tailoring', ['X'] = 'Archaeology', ['Z'] = 'First Aid', },
		...
		reputationExpansionMapping = {
			...
			[6] = { 1445, 1515, 1520, 1679, 1681, 1682, 1708, 1710, 1711, 1731, 1732, 1733, 1735, 1736, 1737, 1738, 1739, 1740, 1741, },
			},
		...
		AchievementComplete = function(self, soughtAchievementId, onlyPlayerCompleted)
			...
			return onlyPlayerCompleted and playerCompletedIt or achievementComplete
		end,
...
--						canAcceptQuest = Grail:CanAcceptQuest(value, true)
				...
				good =
					...
					(checkLevelMeetsOrExceeds and levelMeetsOrExceeds)
...
print("end:", strgsub(controlTable.something, "|", "*"))
		...
		_ProcessQuestsForHandlersMapping = { ["B"] = 'D', ["D"] = 'D', ["e"] = 'D', ["I"] = 'B', ["J"] = 'A', ["K"] = 'C', ["L"] = 'E', ["M"] = 'F', ["N"] = 'F', ["R"] = 'R', ["S"] = 'Y', ["V"] = 'X', ["W"] = 'W', ["Y"] = 'B', ["Z"] = 'Z' },
...
--				end
		...
		_SendQuestChoiceList = {
			...
			[135] = 36527,	-- Stronghold Alliance Stonefury Cliffs	-- Also, 36549 as well
			[136] = 36560,	-- Stronghold Alliance Shattrath	-- Also, 36561 was set as well
			[149] = 36676,	-- Everbloom Wilds Alliance 36533 36552
			[157] = 36556,	-- Socrethar's Rise Alliance 36351 36664
			[163] = 36537,	-- Shadowmoon Enclave Alliance 36664 36558
			},
		...
		_SendQuestChoiceResponse = function(self, anId)
			...
			if GrailDatabase.debug then print("_SendQuestChoiceResponse chooses:", anId, numericOption, "coords:", self:Coordinates()) end
...
--				else
--					hyperlinkFormat = 'unit:GameObject:0:0:0:0:' .. npcIdToUse - 100000000
--				end
			elseif npcIdToUse > 1000000 then
				hyperlinkFormat = strformat("unit:0xF51%05X00000000", npcIdToUse - 1000000)
			else
				if self.blizzardRelease < 18505 then
					hyperlinkFormat = strformat("unit:0xF53%05X00000000", npcIdToUse)
				else
					hyperlinkFormat = 'unit:Creature:0:0:0:0:' .. npcIdToUse
				end
			end
