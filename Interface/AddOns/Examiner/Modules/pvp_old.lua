...
function mod:LoadArenaTeamsNormal()
	do return end	-- Az: this function currently does nothing, but will when GetInspectArenaData() is implemented
	for i = 1, MAX_ARENA_TEAMS do
		local arenaRating, seasonPlayed, seasonWon, weeklyPlayed, weeklyWon = GetInspectArenaData(i);	-- 5.4: This is the new arena function -- Az: not implemented yet
		--local at = ad[i];
		--if (ex.isSelf) then
