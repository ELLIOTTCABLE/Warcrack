...
L["EXPIRY_ALL_ACCOUNTS_LABEL"] = "Revisar todos los tiempos de borrado de correo en todas las cuentas conocidas" -- Needs review
...
L["EXPIRY_ALL_REALMS_LABEL"] = "Revisar todos los tiempos de borrado de correo en todas los reinos conocidos" -- Needs review
...
L["EXPIRY_CHECK_LABEL"] = "Advertencia de Borrado de Correo" -- Needs review
...
L["SCAN_MAIL_BODY_LABEL"] = "Escanear el contenido de los correos (marcarlos como leídos)" -- Needs review
