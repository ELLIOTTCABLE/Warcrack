...
L["%s is %s with %s (%d/%d)"] = "%s est %s auprès de %s (%d/%d)" -- Needs review
...
L["%s will be unlocked in %d minutes (%s on %s)"] = "%s sera disponible dans %d minutes (%s sur %s)" -- Needs review
...
L["Detailed guild bank count"] = "Décompte détaillé de la banque de guilde" -- Needs review
...
L["Include guild members' professions"] = "Inclure les métiers des membres de la guilde" -- Needs review
...
L["Week starts on Monday"] = "La semaine commence le lundi" -- Needs review
