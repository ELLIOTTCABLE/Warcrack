--[[
	...
	Revision: $Id: PostMonitor.lua 4811 2010-06-25 21:35:35Z kandoko $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/auctioneer/branches/5.12/BeanCounter/PostMonitor.lua $","$Rev: 4811 $","5.1.DEV.", 'auctioneer', 'libs')
