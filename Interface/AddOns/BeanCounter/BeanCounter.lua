--[[
	...
	Revision: $Id: BeanCounter.lua 5123 2011-04-06 20:34:59Z kandoko $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/auctioneer/branches/5.12/BeanCounter/BeanCounter.lua $","$Rev: 5123 $","5.1.DEV.", 'auctioneer', 'libs')
