...
L["Delay"] = "Délai"
L["Desaturated Icons"] = "Icônes désaturées" -- Needs review
...
L["Fixed"] = "Fixé" -- Needs review
L["Fixed/Max Text Width"] = "Largeur fixe/max du texte" -- Needs review
L["Font"] = "Police d'écriture"
L["Fonts and Textures"] = "Polices et textures"
L["Font Size"] = "Taille de la police"
L["Force Text Color"] = "Forcer la couleur du texte"
L["Free"] = "Libre" -- Needs review
L["Free Placement"] = "Placement libre"
L["Gap"] = "Espacement"
L["General"] = "Général"
L["Get back my plugins!"] = "Rendez-moi mes plugins !"
L["Hide Bars"] = "Cacher les barres"
L["Hide Bars during a Pet Battle."] = "Cache les barres pendant les combats de mascottes." -- Needs review
L["Hide Bars in Pet Battle"] = "Cacher les barres dans les combats de mascottes" -- Needs review
...
L["How should the plugin width adapt to the text?"] = "Comment la largeur du plugin doit s'adapter au texte ?" -- Needs review
...
L["Set fixed or max width for the text."] = "Définit la largeur fixe ou maximale du texte." -- Needs review
...
L["Show icons in gray scale mode (This will not affect icons embedded in the text of a plugin)."] = "Affiche les icônes en mode échelle de gris (ceci n'affectera pas les icônes intégrées dans le texte d'un plugin)." -- Needs review
...
L["Width Behavior"] = "Comportement de la largeur" -- Needs review
