--[[
	...
	Revision: $Id: StatStdDev.lua 5159 2011-05-14 19:18:45Z Nechckn $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.12/Auc-Stat-StdDev/StatStdDev.lua $", "$Rev: 5159 $")
