...
L["1 combo point: yellow, 5 combo points: red"] = "1 combo point: yellow, 5 combo points: red" -- Requires localization
...
L["Adjust the horizontal position of the aura icon"] = "Adjust the horizontal position of the aura icon" -- Requires localization
L["Adjust the vertical placement of this bar"] = "Adjust the vertical placement of this bar" -- Requires localization
L["Adjust the vertical position of the aura icon"] = "Adjust the vertical position of the aura icon" -- Requires localization
L["Adjusts the size of the aura icon for this bar"] = "Adjusts the size of the aura icon for this bar" -- Requires localization
...
L["Aura icon horizontal offset"] = "Aura icon horizontal offset" -- Requires localization
L["Aura icon scale"] = "Aura icon scale" -- Requires localization
L["Aura icon vertical offset"] = "Aura icon vertical offset" -- Requires localization
...
L["Display aura icon"] = "Display aura icon" -- Requires localization
L["Display mode"] = "Display mode" -- Requires localization
...
L["Whether we are tracking a buff or debuff"] = "Whether we are tracking a buff or debuff" -- Requires localization
