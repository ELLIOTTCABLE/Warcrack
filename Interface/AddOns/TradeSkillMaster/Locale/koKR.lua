...
L["Add Items to this Group"] = "이 그룹에 아이템 추가" -- Needs review
L["Additional error suppressed"] = "추가적인 오류 표시 안 함"
L["Adjust Post Parameters"] = "등록 설정 변경" -- Needs review
L["Advanced Option Text"] = "고급 옵션 문자" -- Needs review
L["Advanced topics..."] = "고급 주제..." -- Needs review
...
L["All items with names containing the specified filter will be selected. This makes it easier to add/remove multiple items at a time."] = "필터에 지정된 이름을 포함하는 모든 아이템을 선택합니다. 한번에 여러 아이템을 추가/제거할 수 있습니다."
...
L["Along the bottom of the AH are various tabs. Click on the 'Auctioning' AH tab."] = "경매장 창 밑에 여러 개 탭 중에서 \"Auctioning\"을 클릭하세요." -- Needs review
L["Along the bottom of the AH are various tabs. Click on the 'Shopping' AH tab."] = "경매장 창 밑에 여러 개 탭 중에서 \"Shopping\"을 클릭하세요." -- Needs review
L["Along the top of the TSM_Crafting window, click on the 'Professions' button."] = "TSM_Crafting 창 맨 위에서 \"Profession\"을 클릭하세요." -- Needs review
L["Along the top of the TSM_Crafting window, click on the 'TSM Groups' button."] = "TSM_Crafting 창 맨 위에서 \"TSM Groups\"을 클릭하세요." -- Needs review
L["Along top of the window, on the left side, click on the 'Groups' icon to open up the TSM group settings."] = "창 왼쪽 위에서 \"그룹\"을 클릭하면 TSM 그룹 설정창이 열립니다." -- Needs review
...
L["Alt-Click to immediately buyout this auction."] = "Alt-Click 하면 이 아이템을 즉시 구매합니다."
L["A maximum of 1 convert() function is allowed."] = "convert() 함수가 허용하는 최대치는 1입니다."
L["A maximum of 1 gold amount is allowed."] = "1 골드가 최대 허용치입니다."
L["Any subgroups of this group will also be deleted, with all items being returned to the parent of this group or removed completely if this group has no parent."] = "이 그룹의 모든 하위 그룹은 삭제되고 아이템은 상위 그룹으로 반환되거나 상위 그룹이 없다면 제거됩니다."
L["Appearance Data"] = "외관 데이터"
L["Application and Addon Developer:"] = "애플리케이션 및 애드온 개발자:"
...
L["Below are your currently available price sources. The %skey|r is what you would type into a custom price box."] = "아래는 현재 가능한 가격 출처입니다. %s키|r이(가) 사용자 가격에 입력 될 것입니다."
...
L["Canceling Auction: %d/%d"] = "경매 취소 중: %d/%d"
L["Cancelled - Bags and bank are full"] = "취소 - 가방과 은행 꽉 참"
L["Cancelled - Bags and guildbank are full"] = "취소 - 가방과 길드은행 꽉 참"
L["Cancelled - Bags are full"] = "취소 - 가방 꽉 참"
L["Cancelled - Bank is full"] = "취소 - 은행 꽉 참"
L["Cancelled - Guildbank is full"] = "취소 - 길드은행 꽉 참"
L["Cancelled - You must be at a bank or guildbank"] = "취소 - 은행 또는 길드은행에 있어야 합니다."
L["Cannot delete currently active profile!"] = "현재 활성화된 프로파일은 삭제할 수 없습니다!"
...
L["Create a new empty profile."] = "비어있는 새 프로파일을 생성합니다."
...
L["Disenchant source:"] = "마력추출 출처:"
L["Disenchant Value"] = "마력추출 가격"
L["Disenchant Value:"] = "마력추출 가격:"
L["Disenchant Value x%s:"] = "마력추출 가격 x%s:"
L["Display disenchant value in tooltip."] = "툴팁에 마력추출 가격 표시"
L["Display Group / Operation Info in Tooltips"] = "툴팁에 그룹 / 작업 정보 표시"
L["Display prices in tooltips as:"] = "툴팁에 가격 표시:"
...
-- L["Export Operation"] = ""
L["Failed to parse gold amount."] = "골드량 파싱 실패."
...
L["If checked, all tables listing auctions will display the bid as well as the buyout of the auctions. This will not take effect immediately and may require a reload."] = "체크 시 경매장 물품목록에 입찰가와 즉구가도 표기됩니다. 다시 불러오기(/reload) 이후 적용됩니다."
...
L["Invalid custom price for undercut amount. Using 1c instead."] = "에누리에 대한 사용자 가격이 잘못되었습니다. 대신 1c를 사용합니다."
L["Invalid filter."] = "잘못된 필터입니다."
...
L["Lead Developer and Co-Founder:"] = "주 개발자 및 공동 개발자:"
...
L["Module Operations / Options"] = "모듈 작업 / 옵션"
-- L["Modules"] = ""
...
L["Multi-Account Settings"] = "다중 계정 설정"
...
L["<No Group Selected>"] = "<선택된 그룹 없음>" -- Needs review
L["No modules are currently loaded.  Enable or download some for full functionality!"] = "현재 불러들인 모듈이 없습니다. 모듈을 활성화하거나 다운로드하세요."
...
L["<No Operation Selected>"] = "<선택된 작업 없음>" -- Needs review
...
-- L["Post Your Items"] = ""
L["Price Per Item"] = "아이템당 가격"
L["Price Per Stack"] = "묶음당 가격"
L["Price Per Target Item"] = "대상 아이템당 가격"
...
L["Profiles"] = "프로파일"
L["Provides extra functionality that doesn't fit well in other modules."] = "다른 모듈에 포함되기에 적합하지 않은 추가 기능을 제공합니다."
...
L["Purchasing Auction: %d/%d"] = "경매 구매: %d/%d"
...
L["Select the price source for calculating disenchant value."] = "마력추출 값을 계산할 가격의 출처를 선택하세요."
...
L["Settings"] = "설정"
L["Setup account sync'ing with the account which '%s' is on."] = "계정 '%s'과 동기화 설정이 켜져있습니다."
...
L["Show Bids in Auction Results Table (Requires Reload)"] = "경매결과 테이블에 입찰정보 보기 (Reload후 적용)"
...
L["Show Ungrouped Items for Adding to Subgroups"] = "하위 그룹에 추가할 수 있도록 그룹이 없는 아이템 표시"
...
L["Skipping auction which no longer exists."] = "더이상 존재하지 않는 경매를 건너뜁니다."
...
L["Status / Credits"] = "상태 / 제작자"
L["Store Operations Globally"] = "설정 통합 저장"
L["Subgroup Items:"] = "하위 그룹 아이템:"
L["Subgroups contain a subset of the items in their parent groups and can be used to further refine how different items are treated by TSM's modules."] = "하위 그룹은 상위 그룹 아이템의 부분 집합이며 TSM 모듈에 의해서 아이템이 다른 방식으로 처리되도록 할 수 있습니다."
...
L["TSM Status / Options"] = "TSM 상태 / 옵션"
L["TSM Version Info:"] = "TSM 버전 정보:"
L["TUJ GE - Market Average"] = "TUJ GE - 시장 평균"
L["TUJ GE - Market Median"] = "TUJ GE - 시장 중앙값"
L["TUJ RE - Market Price"] = "TUJ RE - 시장 가격"
L["TUJ RE - Mean"] = "TUJ RE - 평균"
...
L["Use the button below to delete this group. Any subgroups of this group will also be deleted, with all items being returned to the parent of this group or removed completely if this group has no parent."] = "이 그룹을 삭제하려면 아래 버튼을 이용하세요. 이 그룹에 포함된 모든 하위 그룹은 삭제되고 모든 아이템은 상위 그룹으로 반환되거나 상위 그룹이 없다면 제거됩니다."
L["Use the editbox below to give this group a new name."] = "아래 편집 상자를 이용해 이 그룹에 새 이름을 부여합니다."
...
L["Use the tabs above to select the module for which you'd like to configure operations and general options."] = "작업 구성과 일반 옵션 설정을 원하는 모듈을 위의 탭에서 선택하세요."
L["Use the tabs above to select the module for which you'd like to configure tooltip options."] = "툴팁 옵션 설정을 원하는 모듈을 위의 탭에서 선택하세요."
...
L["Visit %s for information about the different TradeSkillMaster modules as well as download links."] = "%s 를 방문하면 TradeSkillMaster의 여러 모듈의 정보를 확인하고 다운로드 받으실 수 있습니다."
...
L["Wrong number of item links."] = "아이템 링크의 갯수가 잘못되었습니다."
...
Once you're done, click on the button below.]=] ] = "" ]==]
L["You cannot create a profile with an empty name."] = "이름이 공백인 프로파일은 생성할 수 없습니다."
