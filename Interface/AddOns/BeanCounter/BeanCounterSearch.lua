--[[
	...
	Revision: $Id: BeanCounterSearch.lua 5127 2011-04-21 18:06:00Z kandoko $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/auctioneer/branches/5.12/BeanCounter/BeanCounterSearch.lua $","$Rev: 5127 $","5.1.DEV.", 'auctioneer', 'libs')
