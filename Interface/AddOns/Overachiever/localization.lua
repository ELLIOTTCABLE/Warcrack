...
-- L["ACH_FISHSCHOOL_FORMAT"] = ""
L["ACH_FISTFULOFLOVE_COMPLETE"] = "已用过一把玫瑰花瓣"
L["ACH_FISTFULOFLOVE_INCOMPLETE"] = "需使用一把玫瑰花瓣"
L["ACH_LETITSNOW_COMPLETE"] = "已用过一捧雪花"
L["ACH_LETITSNOW_INCOMPLETE"] = "需使用一捧雪花"
...
L["OPT_CONSUMEITEMTIPS_WHENCOMPLETE"] = "完成后是否继续提示"
L["OPT_CRITTERTIPS"] = "提示小动物是否被 /爱 过？"
L["OPT_CRITTERTIPS_TIP"] = "在小动物的提示说明中注明." -- Needs review
L["OPT_DRAGGABLE"] = "使其可拖动"
L["OPT_DRAGLOCK"] = "锁定位置"
L["OPT_DRAGSAVE"] = "记住位置"
L["OPT_DRAG_ACHFRAME"] = "主成就界面框体"
L["OPT_DRAG_ACHTRACKER"] = "成就追踪"
L["OPT_FISTFULOFLOVETIPS"] = "是否需要使用一把玫瑰花瓣？"
...
L["OPT_LABEL_ACHTWO"] = "\"%s\"和\"%s\""
L["OPT_LABEL_DRAG"] = "可移动框架"
L["OPT_LABEL_MAINUI"] = "主成就界面修正"
-- L["OPT_LABEL_NEEDTOKILL"] = ""
L["OPT_LABEL_SEASONALACHS"] = "季节性成就"
L["OPT_LABEL_TOOLTIPS"] = "成就提示和链接"
L["OPT_LABEL_TRACKING"] = "成就追踪"
-- L["OPT_LABEL_TRADESKILLUI"] = ""
L["OPT_LETITSNOWTIPS"] = "是否需要使用一捧雪花？"
...
L["SOUND_DRUMHIT"] = "击鼓声"
L["SOUND_ENTERQUEUE"] = "进入队列"
L["SOUND_GONG_TROLL"] = "锣声 - 巨魔"
L["SOUND_HEARTHBIND"] = "炉石绑定"
...
L["ACH_BUNNYMAKER_COMPLETE"] = "봄꽃 사용 완료"
