    ...
    { -- section 2
        ...
        { -- column 3
            ...
            },
            {
                ...
                type = "editBoxDropDown",
                tooltipText = "Add here the names of timers you wish to see onscreen.  The timer name much match exactly (case insensitive) to be shown.",
                setting = "visible",
                simple = true,
                scripts = {
                    OnShow = function(self)
                    ...
                    scripts = {
                        ...
                        OnEnterPressed = function(self) 
                            ...
                            if AsheylaLib_Settings[name] then
                                alertUser("You cannot use that name.  Try again!");
                            elseif name ~= "" then
