...
L["Agenda"] = "Повестка дня" -- Needs review
...
L["COLOR_GREEN"] = "Зеленый" -- Needs review
L["COLOR_GREY"] = "Серый" -- Needs review
...
L["Detailed guild bank count"] = "Детальная ячейка банка гильдии" -- Needs review
...
L["Items"] = "Предметы"
L["ITEM_SUBTYPE_BOOK"] = "Книга" -- Needs review
L["ITEM_TYPE_RECIPE"] = "Рецепты" -- Needs review
...
L["TIME_TO_NEXT_WARNING_TEXT"] = "Время до следующего предупреждения" -- Needs review
L["TIME_TO_NEXT_WARNING_TOOLTIP"] = "Минимальное время перед тем, как вы получите следующее предупреждение об истечении срока" -- Needs review
