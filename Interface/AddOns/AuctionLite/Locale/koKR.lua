...
L["(none set)"] = "(설정 없음)"
L["Accept"] = "수락"
L["Add a new item to a favorites list by entering the name here."] = "여기에 입력하세요." -- Needs review
L["Add an Item"] = "물품 추가"
L["Advanced"] = "추가기능"
L["Always"] = "항상 표시"
...
L["Bid Undercut (Fixed)"] = "경매 시작가 할인(고정값)" -- Needs review
...
L["Buyout Undercut (Fixed)"] = "즉시 구입가 할인(고정값)" -- Needs review
L["Buyout cannot be less than starting bid."] = "즉시 구입가가 경매 시작가 보다 낮습니다."
L["Buyout cost for %d:"] = "%d개 즉시 구매가:"
L["CANCEL_CONFIRM_TEXT"] = "경매가 입찰 진행중입니다. 전체 경매, 입찰이 되지 않은 경매, 취소 안함을 선택할 수 있습니다." -- Needs review
L["CANCEL_NOTE"] = "CANCEL_NOTE" -- Needs review
...
L["Cancelled %d |4listing:listings; of %s."] = "취소됨 %d |4listing:목록; of %s."
L["Choose a favorites list to edit."] = "편집할 물품 선택" -- Needs review
L["Choose which tab is selected when opening the auction house."] = "경매장을 열 때 어떤 탭에서 시작할지 선택할 수 있습니다."
L["Clear All"] = "모두 삭제" -- Needs review
...
L["Create a new favorites list."] = "즐겨찾는 물품 추가" -- Needs review
L["Created %d |4auction:auctions; of %s x%d (%s total)."] = "경매 시작: %d건 (%s x %d개, 합계: %s)"
L["Created %d |4auction:auctions; of %s x%d."] = "경매 시작: %d건 (%s x %d)"
...
L["Delete"] = "삭제"
L["Delete the selected favorites list."] = "선택된 물품 삭제" -- Needs review
L["Disable"] = "사용 안 함"
L["Disenchant"] = [=[마력 추출
]=]
L["Do Nothing"] = "취소" -- Needs review
L["Do it!"] = "바로 해!"
L["Enable"] = "사용함"
...
L["Favorites"] = "즐겨찾기" -- Needs review
L["Fixed amount to undercut market value for bid prices (e.g., 1g 2s 3c)."] = "시세보다 얼마만큼 내릴 것인지 경매 시작가를 정합니다. (예시(금액 단위는 영문으로): 1g 2s 3c)" -- Needs review
L["Fixed amount to undercut market value for buyout prices (e.g., 1g 2s 3c)."] = "시세보다 얼마만큼 내릴 것인지 즉시 구입가를 정합니다. (예시(금액 단위는 영문으로): 1g 2s 3c)" -- Needs review
L["Full Scan"] = "전체 검색"
L["Full Stack"] = "최대 묶음"
...
L["Listing %d of %d"] = "%d개 품목 구입 (총 %d개 품목)" -- Needs review
L["Listings"] = "품목"
L["Market Price"] = "시세"
L["Max Stacks"] = "최대 묶음"
...
L["Note: %d |4listing:listings; of %d |4item was:items were; not purchased."] = "알림: %d 건의 %d|1을;를; 구매하지 못했습니다."
...
L["One Item"] = "One Item"
L["One Stack"] = "One Stack" -- Needs review
...
L["Placement of tooltips in \"Buy\" and \"Sell\" tabs."] = "\\\"구입\\\" 과 \\\"판매\\\" 탭에서 툴팁의 위치를 정합니다." -- Needs review
...
L["Profiles"] = "프로필"
L["Qty"] = "희망 수량"
L["Remove Items"] = "항목 삭제"
L["Remove the selected items from the current favorites list."] = "현재의 즐겨찾기 목록에서 선택한 항목을 제거합니다."
...
L["Stack Count"] = "묶음 개수"
L["Stack Size"] = "묶음 크기"
L["Stack size suggested when an item is first placed in the \"Sell\" tab."] = " Stack size suggested when an item is first placed in the \"Sell\" tab."
L["Stack size too large."] = "묶음 크기가 너무 큽니다."
L["Start Tab"] = "처음 시작할 탭"
L["Store Price Data"] = "가격 정보 저장"
L["Store price data for all items seen (disable to save memory)."] = "모든 아이템의 상점가를 표시합니다. (표시하지 않으면 메모리를 절약할 수 있습니다.)"
...
L["|cffff7030Buyout less than vendor price.|r"] = "|cffff7030상점가보다 낮은 즉시구매가로 등록된 물품.|r" -- Needs review
