	...
	["global"] = {
		["Characters"] = {
				...
				["Mails"] = {
					{
						...
						["icon"] = "Interface\\Icons\\INV_Misc_Note_01",
						["money"] = 0,
						["text"] = "Find me online about those bags. I want to make sure we're correct on the pricing before I stitch them up. ",
						["lastCheck"] = 1308176285,
						["daysLeft"] = 29.91102981567383,
					}, -- [1]
				},
				["lastVisitDate"] = "2011/06/15 18:18",
			},
			...
			["Default.Smolderthorn.Battlecollie"] = {
				["lastUpdate"] = 1308176037,
				["lastVisitDate"] = "2011/06/15 18:13",
			},
			["Default.Smolderthorn.Melancollie"] = {
				["lastUpdate"] = 1308081526,
				["lastVisitDate"] = "2011/06/14 15:58",
			},
