...
-- Weapon types
SMARTBUFF_WEAPON_STANDARD = {"Dolche", "\195\164xte", "schwerter", "streitkolben", "St\195\164be", "Faustwaffen", "Wurfwaffe"};
...
SMARTBUFF_OFT_PURGE_DATA     = "Bist du sicher, dass du ALLE SmartBuff Daten zur\195\188cksetzen willst?\nDiese Aktion wird ein neu Laden des UI's durchf\195\188hren!";
...
SMARTBUFF_OFTT_LINKGRPBUFFCHECK  = "Pr\195\188ft ob schon ein Buff\nmit gleichem Effekt von einer\nanderen Klasse aktiv ist.";
SMARTBUFF_OFTT_LINKSELFBUFFCHECK = "Pr\195\188ft ob ein Eigen-Buff\naktiv ist, von welchen jeweils\nnur einer aktiv sein kann.";
