...
L["Use color-coding for recipes at the AH"] = "Färbe Rezepte im Auktionshaus" -- Needs review
L["Use color-coding for recipes at vendors"] = "Färbe Rezepte bei Händlern" -- Needs review
