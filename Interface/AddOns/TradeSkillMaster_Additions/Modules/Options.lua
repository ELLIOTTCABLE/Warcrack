			...
			children = {
				{
					...
					children = {
						...
						},
						{
							...
							relativeWidth = 1,
							settingInfo = {TSM.db.global, "enableAuctionBuys"},
							quickCBInfo = {TSM.db.global, "enableAuctionBuys"},
				...
				},
				{
					...
					children = {
						...
						},
						{
							...
							settingInfo = {TSM.db.global, "soundEnabled"},
							quickCBInfo = {TSM.db.global, "soundEnabled"},
							tooltip = L["Play a cash register sound when a sale is made"],
						},
					},
				},
				{
