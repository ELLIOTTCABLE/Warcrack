...
--   FONT
-- -----
LSM:Register(MediaType_FONT, "Adventure",					[[Interface\Addons\SharedMedia\fonts\Adventure.ttf]])
LSM:Register(MediaType_FONT, "Atarian System",				[[Interface\Addons\SharedMedia\fonts\SFAtarianSystem.ttf]])
LSM:Register(MediaType_FONT, "Bazooka",						[[Interface\Addons\SharedMedia\fonts\Bazooka.ttf]])
LSM:Register(MediaType_FONT, "Black Chancery",				[[Interface\Addons\SharedMedia\fonts\BlackChancery.ttf]])
LSM:Register(MediaType_FONT, "Celestia Redux",				[[Interface\Addons\SharedMedia\fonts\CelestiaMediumRedux1.55.ttf]])
LSM:Register(MediaType_FONT, "Covington",					[[Interface\Addons\SharedMedia\fonts\SFCovington.ttf]])
LSM:Register(MediaType_FONT, "DorisPP",						[[Interface\Addons\SharedMedia\fonts\DORISPP.ttf]])
LSM:Register(MediaType_FONT, "Enigmatic",					[[Interface\Addons\SharedMedia\fonts\Enigma__2.ttf]])
LSM:Register(MediaType_FONT, "Fitzgerald",					[[Interface\Addons\SharedMedia\fonts\Fitzgerald.ttf]])
LSM:Register(MediaType_FONT, "Gentium",						[[Interface\Addons\SharedMedia\fonts\Gentium.ttf]])
LSM:Register(MediaType_FONT, "Hooked Up",					[[Interface\Addons\SharedMedia\fonts\HookedUp.ttf]])
LSM:Register(MediaType_FONT, "Liberation Sans",				[[Interface\Addons\SharedMedia\fonts\LiberationSans.ttf]])
LSM:Register(MediaType_FONT, "Movie Poster",				[[Interface\Addons\SharedMedia\fonts\SFMoviePoster-Bold.ttf]])
LSM:Register(MediaType_FONT, "swf!t",						[[Interface\Addons\SharedMedia\fonts\swfit.ttf]])
LSM:Register(MediaType_FONT, "Vera Serif",					[[Interface\Addons\SharedMedia\fonts\VeraSe.ttf]])
LSM:Register(MediaType_FONT, "WenQuanYi Zen Hei",			[[Interface\Addons\SharedMedia\fonts\wqy-zenhei.ttf]],				koKR + ruRU + zhCN + zhTW + western)
LSM:Register(MediaType_FONT, "Wonder Comic",				[[Interface\Addons\SharedMedia\fonts\SFWonderComic.ttf]])
LSM:Register(MediaType_FONT, "Yellowjacket",				[[Interface\Addons\SharedMedia\fonts\YELLOWJACKET.ttf]])
