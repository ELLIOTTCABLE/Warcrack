...
L["1 combo point: yellow, 5 combo points: red"] = "1 連擊點:黃色, 5 連擊點:紅色"
...
L["Allow click-targeting in combat"] = "戰門內允許點擊目標"
L["Allow mouse interaction"] = "允許滑鼠交互"
L["Alpha OOC and Target"] = "透明度 OOC 及目標"
L["Alpha OOC and not full"] = "透明度 OCC 及不充滿"
L["Alpha in combat"] = "戰鬥內透明度"
L["Alpha out of combat"] = "戰鬥外透明度"
L["Always display bar"] = "永遠顯示條列"
L["Always show at 100% alpha"] = "永遠顯示在100% 透明度"
...
L["BG Alpha out of combat"] = "戰鬥外背景透明度"
...
L["Click to open IceHUD options."] = "點擊開啟 IceHUD 選項"
L["Color"] = "顏色"
...
L["Enable/disable IceHUD"] = "啟用/停用 IceHUD"
...
Remember to press ENTER after filling out this box with the name you want or it will not save.]=] -- Requires localization
L["Error: IceHUD database not loaded correctly.  Please exit out of WoW and delete the database file (IceHUD.lua) found in: \\World of Warcraft\\WTF\\Account\\<Account Name>>\\SavedVariables\\"] = "錯誤: IceHUD 資料庫末正載入。請 WOW 退出之後而且刪除資料庫檔案 (IceHUD.lua) 找到在: \\World of Warcraft\\WTF\\帳號\\<<帳號名字>>\\SavedVariables\\"
...
L["IceHUD"] = "IceHUD"
L["IceHUD Bar Background Blend mode"] = "IceHUD 條列背景混合模式"
L["IceHUD Bar Blend mode"] = "IceHUD 條列混合模式"
L["IceHUD Bar Texture"] = "IceHUD 條列材質"
...
L["Whether or not to show an IceHUD icon on the minimap."] = "無論是不是顯示在小地圖的 IceHUD"
