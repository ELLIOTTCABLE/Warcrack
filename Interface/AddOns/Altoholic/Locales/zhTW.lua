...
L["Update current tab from"] = "更新目前的標籤" -- Needs review
L["Upper Deck"] = "桌面紙牌"
L["up to"] = "最高至"
L["Up to %s"] = "升到%s"
L["Use color-coding for recipes at the AH"] = "拍賣場使用配方的顏色編碼" -- Needs review
L["Use color-coding for recipes at vendors"] = "供應商使用配方的顏色編碼" -- Needs review
