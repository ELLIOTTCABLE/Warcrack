...
L["1) Open up a bank (either the gbank or personal bank)"] = "1) 开启银行 (公会银行或个人银行)"
L["1) Select Operations on the left menu and type a name in the textbox labeled \"Operation Name\", hit okay"] = "1) 选择左侧菜单中的操作并在\"操作名称\"文本框内输入名称, 点击完成按钮"
...
L["Error creating operation. Operation with name '%s' already exists."] = "创建操作失败， '%s' 操作已存在。"
L["Example 1: /tsm get glyph 20 - get up to 20 of each item in your bank/guildbank where the name contains\"glyph\" and place them in your bags."] = "例1: /tsm get glyph 20 - 从银行/公会银行中移动20个名称中包含\"glyph\"的物品到你的背包内(模糊匹配)。"
...
L["To create a Warehousing Operation"] = "创建一个Warehousing操作"
